		...
		<table class="table table-bordered datatable table-hover">
			...
			<tbody>
				<tr v-for="(role, index) in pageInfo.content">
					...
					<td class="btn-td">
						<a class="btn btn-sm" :href="'edit.do?roleId='+role.roleId"><s:message code="label.common.modify"/></a>
						<button class="btn btn-sm btn-danger" type="button" @click.prevent="deleteObject(role)"><s:message code="label.common.delete"/></button>
					</td>
				</tr>
			</tbody>
		</table>
